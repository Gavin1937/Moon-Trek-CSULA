            ...
            <div class="infoBox">
                ...
                <div class="MoonBox">
                    <div class="MoonBoxLeft">
                        <h2 class="MoonTrekDescriptionTitle">
                            How Does it Work?
                            <hr />
                        </h2>
                        <p class="MoonTrekDescription">
                            Moon Trek Telescope is an application that allows you to submit your own
                            images of the moon and receive useful information within the field of
                            view, such as annotations, layering, etc.
                        </p>
                    </div>
                    ...
                    <div class="MoonBoxRight">
                        ...
                        <p class="MoonTrekDescription">
                            ...
                            pulvinar enim, ac pretium purus. Donec pellentesque nec purus in luctus.
                            Morbi enim nibh.
                        </p>
                    </div>
                </div>
                    ...
                    <div class="column has-text-centered">
                        <router-link to="upload">
                            <button class="getStarted">
                                <p class="getStartedText">GET STARTED</p>
                            </button>
                        </router-link>
                    </div>
                </div>
